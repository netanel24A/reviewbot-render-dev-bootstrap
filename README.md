...
- The rotated refresh ciphertext is committed before deployment, and the deployed source marker is committed only after Render reports a live deployment and both public health gates pass.
